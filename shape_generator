...
# Define Class for shape generation
class Shape:
    #---------------------------------------------------------
    def __init__(self,
                 name          ='shape',
    ...
    def generate(self, *args, **kwargs):
        ...
        #end of kwargs
        # Generate control points if not given
    ...
    # Write csv -wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
    def write_csv(self):
    ...
    #end of write csv -wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww

    #shape from csv-vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
    ...
    # end of shape from csv - vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
    #Meshing-iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii
    ...
    #end of meshing -iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii
    
    #graph-ppppppppppppppppppppppppppppppppppppppppppppp
    ...
    #end of graph -pppppppppppppppppppppppppppppppppppp

    #---------------------------------------------shape deformation from field -----------------------------------------------------------------
    ...
    #---------------------------------------------End shape deformation from field -----------------------------------------------------------------
    #################################################shape area#####################################
